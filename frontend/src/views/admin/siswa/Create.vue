    ...
    <div v-if="isSuccess" class="bg-white rounded-[2.5rem] shadow-xl border border-gray-100 p-8 text-center space-y-6">
      ...
      <div class="flex flex-col gap-3">
        <button 
          ...
          class="w-full py-4 bg-primary hover:opacity-90 text-white font-bold rounded-2xl shadow-lg shadow-blue-600/20 transition-all flex items-center justify-center gap-2 cursor-pointer"
        >
      ...
      <form @submit.prevent="handleCreateSiswa" class="space-y-6">
        ...
        <div class="space-y-1.5">
          ...
          <div class="relative group">
            ...
            <input 
              ...
              class="w-full pl-12 pr-4 py-4 rounded-2xl bg-gray-50 border-none focus:ring-2 focus:ring-primary transition-all font-bold text-gray-900 placeholder:text-gray-300"
              required
            />
          </div>
        </div>
        ...
        <div class="space-y-1.5">
          ...
          <div class="relative group">
            ...
            <input 
              ...
              class="w-full pl-12 pr-12 py-4 rounded-2xl bg-gray-50 border-none focus:ring-2 focus:ring-primary transition-all font-bold text-gray-900 placeholder:text-gray-300"
              minlength="8"
              required
            />
            <button 
        ...
        <div class="flex gap-4 pt-6 border-t border-gray-100">
          ...
          <button 
            ...
            class="flex-2 bg-primary hover:opacity-90 disabled:opacity-50 text-white py-4.5 rounded-2xl font-bold shadow-lg shadow-blue-600/20 transition-all flex items-center justify-center gap-2 cursor-pointer uppercase tracking-widest text-xs"
          >
